...
import com.hubin.utils.suppor.XssSqlHttpServletRequestWrapper;
 ...
 *
 * @author hubin
 * @title: http request response 过滤XSS SQL 数据工具类
 * @description:
...
public class RequestResponseUtil {
    ...
    public static Map<String, String> getRequestBodyMap(ServletRequest request) {
        ...
        if (request.getAttribute(STR_BODY) != null) {
            ...
            try {
//                Map<String,String > maps = getBodyString(request);
                Map<String, String> maps = JSONObject.parseObject(request.getInputStream(), Map.class);
                dataMap.putAll(maps);
    ...
    public static void getRequestParams(HttpServletRequest request) {
